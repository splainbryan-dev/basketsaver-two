  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      if (mode === "signup") {
        ...
        users.push(user);
        localStorage.setItem("basketsaver_users", JSON.stringify(users));
        localStorage.setItem("basketsaver_user", JSON.stringify({ id: user.id, name: user.name, email: user.email }));
      } else {
        const users = JSON.parse(localStorage.getItem("basketsaver_users") || "[]");
